...
module EBAZ4205
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.ENET0_GMII_RX_CLK_0 CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.ENET0_GMII_RX_CLK_0, CLK_DOMAIN EBAZ4205_ENET0_GMII_RX_CLK_0, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.000" *) input ENET0_GMII_RX_CLK_0;
  input ENET0_GMII_RX_DV_0;
  output [3:0]ENET0_GMII_TXD_0;
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.ENET0_GMII_TX_CLK_0 CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.ENET0_GMII_TX_CLK_0, CLK_DOMAIN EBAZ4205_ENET0_GMII_TX_CLK_0, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.000" *) input ENET0_GMII_TX_CLK_0;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:data:1.0 DATA.GPIO DATA" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME DATA.GPIO, LAYERED_METADATA undef" *) output [3:0]GPIO;
  (* X_INTERFACE_INFO = "xilinx.com:signal:data:1.0 DATA.LED_G DATA" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME DATA.LED_G, LAYERED_METADATA undef" *) output LED_G;
  (* X_INTERFACE_INFO = "xilinx.com:signal:data:1.0 DATA.LED_R DATA" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME DATA.LED_R, LAYERED_METADATA undef" *) output LED_R;
  ...
  assign ENET0_GMII_RXD_0_1 = ENET0_GMII_RXD_0[3:0];
