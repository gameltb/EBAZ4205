...
set_property PACKAGE_PIN V12 [get_ports {GPIO[0]}]
set_property PACKAGE_PIN U12 [get_ports {GPIO[1]}]
set_property PACKAGE_PIN V15 [get_ports {GPIO[2]}]
set_property PACKAGE_PIN V13 [get_ports {GPIO[3]}]